...
void display_eink() {
  ...
  do
  {
    ...
    epdDisplay.printf("'C");
    epdDisplay.setCursor(13, 27 + 4);
    epdDisplay.printf("Vocht");
    epdDisplay.setCursor(37, 27 + 14);
    epdDisplay.printf("%%");
    epdDisplay.setCursor(81, 54 + 4);
    epdDisplay.printf("Druk");
    epdDisplay.setCursor(81, 54 + 14);
    epdDisplay.printf("hPa");
    epdDisplay.setCursor(25, 81 + 4);
    epdDisplay.printf("CO2");
    epdDisplay.setCursor(25, 81 + 14);
    epdDisplay.printf("ppm");
    epdDisplay.setCursor(81, 108 + 4);
    epdDisplay.printf("Geluid");
    epdDisplay.setCursor(81, 108 + 14);
    epdDisplay.printf("dB(A)");
    epdDisplay.setCursor(13, 135 + 4);
    epdDisplay.printf("PM2.5");
    epdDisplay.setCursor(25, 135 + 14);
    epdDisplay.printf("ppm");
    epdDisplay.setCursor(81, 162 + 4);
    epdDisplay.printf("UV");
    epdDisplay.setCursor(81, 162 + 14);
    epdDisplay.printf("uW/cm2");
    epdDisplay.setCursor(13, 189 + 4);
    epdDisplay.printf("Licht");
    epdDisplay.setCursor(31, 189 + 14);
    epdDisplay.printf("lx");

    epdDisplay.setTextSize(3);
    epdDisplay.setCursor(1, 0);
    epdDisplay.printf("%4.1f", temp);
    epdDisplay.setCursor(49, 27);
    epdDisplay.printf("%4.1f", humi);
    epdDisplay.setCursor(1, 54);
    epdDisplay.printf("%4.0f", pres);
    epdDisplay.setCursor(49, 81);
    epdDisplay.printf("%4d", co2);
    epdDisplay.setCursor(1, 108);
    epdDisplay.printf("%4.1f", db_avg);
    epdDisplay.setCursor(49, 135);
    epdDisplay.printf("%4.1f", pm2_5);
    epdDisplay.setCursor(1, 162);
    epdDisplay.printf("%4.0f", uva);
    epdDisplay.setCursor(49, 189);
    epdDisplay.printf("%4.0f", lumi);
